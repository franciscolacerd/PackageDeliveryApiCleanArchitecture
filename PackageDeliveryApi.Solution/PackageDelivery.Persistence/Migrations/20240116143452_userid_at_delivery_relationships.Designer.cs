...
namespace PackageDelivery.Persistence.Migrations
{
    ...
    [Migration("20240116143452_userid_at_delivery_relationships")]
    partial class userid_at_delivery_relationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PackageDelivery.Persistence.Entities.ApiLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PackageDelivery.Persistence.Entities.DeliveryAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PackageDelivery.Persistence.Entities.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PackageDelivery.Persistence.Entities.EventType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PackageDelivery.Persistence.Entities.ExceptionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("PackageDelivery.Persistence.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PackageDelivery.Persistence.Entities.DeliveryDeliveryAttribute", b =>
                {
                    ...
                    b.HasOne("PackageDelivery.Persistence.Entities.Delivery", "Delivery")
                        .WithMany("DeliveryDeliveryAttributes")
            ...
            modelBuilder.Entity("PackageDelivery.Persistence.Entities.Event", b =>
                {
                    ...
                    b.HasOne("PackageDelivery.Persistence.Entities.EventType", "EventType")
                        .WithMany("Events")
                    ...
                    b.HasOne("PackageDelivery.Persistence.Entities.Package", "Package")
                        .WithMany("Events")
